 ...
 * 
 * Displays the documentation header with custom branding.
 * Shows logo, site title, and social links based on branding settings.
 */
...
export function BrandedHeader({
  ...
  const baseUrl = customDomain ? '/' : `/docs/${projectSlug}/main`;
